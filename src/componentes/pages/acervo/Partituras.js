...
export const Partituras = () => {
  ...
  const getTemas = async () => {
    const url = "https://backend-prueba-apel.onrender.com/api/partituras/listar-temas";
          ...
          {temas.map((tema, index) => (
            ...
            >
              <article>
                <img
                  id='img_temas'
                  src={`https://backend-prueba-apel.onrender.com/imagenes/partituras/${tema.nombreImagen}`}
                  alt={`${tema.tema} foto`}
                />
