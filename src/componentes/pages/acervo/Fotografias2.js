...
export const Fotografias2 = () => {
  ...
  const getTemas = async () => {
    const url = "https://backend-prueba-apel.onrender.com/api/fotografia/listar-temas";
            ...
            {temas.map((tema, index) => {
              return (
                ...
                >
                    <article>
                  <img id='img_temas'
                    src={`https://backend-prueba-apel.onrender.com/imagenes/general/Temas/fotografia/${tema.tema + ".jpg"}`}
                    alt={`${tema.tema} foto`}
                  />
