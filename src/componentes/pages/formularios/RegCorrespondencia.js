...
export const RegCorrespondencia = () => {
    ...
    const guardar_foto = async (e) => {
        ...
        const { datos } = await Api("http://localhost:3900/api/correspondencia/registrar", "POST", nueva_foto);
        ...
        if (datos.status === "success") {
            ...
            const subida2 = await Api(`http://localhost:3900/api/correspondencia/registrar-imagen/${datos.publicacionGuardada._id}`, "POST", formData, true);
            ...
            const pdfSubida2 = await Api(`http://localhost:3900/api/correspondencia/registrar-pdfs/${datos.publicacionGuardada._id}`, "POST", pdfFormData, true);
