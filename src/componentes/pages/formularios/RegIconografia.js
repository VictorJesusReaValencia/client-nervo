...
export const RegIconografia = () => {
    ...
    const guardar_foto = async (e) => {
        ...
        const { datos } = await Api("http://localhost:3900/api/iconografia/registrar", "POST", nueva_foto);
        ...
        if (datos.status === "success") {
            ...
            const subida2 = await Api(`http://localhost:3900/api/iconografia/registrar-imagen/${datos.publicacionGuardada._id}`, "POST", formData, true);
            ...
            const subida = await Api(`http://localhost:3900/api/iconografia/registrar-imagen/${datos.publicacionGuardada._id}`, "POST", formData, true);
            ...
            const pdfSubida2 = await Api(`http://localhost:3900/api/iconografia/registrar-pdfs/${datos.publicacionGuardada._id}`, "POST", pdfFormData, true);
