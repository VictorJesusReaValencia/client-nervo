  ...
  const { formulario, enviado, cambiado, resetFormulario } = useForm({})
    ...
    const guardar_foto = async (e) => {
        ...
        if (datos.status === "successs") {
            ...
            const subida = await Api(`https://backend-google-fnsu.onrender.com/api/fotografia/registrar-imagen/${datos.publicacionGuardada._id}`, "POST", formData, true);
            ...
            //const { pdfSubida } = await Api(`https://backend-prueba-apel.onrender.com/api/fotografia/registrar-pdf/${datos.publicacionGuardada._id}`, "POST", pdfFormData, true);
            const pdfSubida2 = await Api(`https://backend-google-fnsu.onrender.com/api/fotografia/registrar-pdf/${datos.publicacionGuardada._id}`, "POST", pdfFormData, true);
